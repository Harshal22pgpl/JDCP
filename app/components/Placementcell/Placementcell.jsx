...
export default function Placementcell({ img, title, content }) {
  return (
    <>
      ...
      <div className=" p-10 ">
        <h1 className="text-4xl text-center text-pink-700 border-b-2 border-blue-500">
          Overview...
        </h1>
        <div className="w-full mx-auto pt-5 ml-20">
          <div className="flex  mx-auto">
            ...
            <div className="bg-pink-500 w-[750px] text-white  p-10 translate-x-[-10rem] translate-y-12 opacity-80 ">
      ...
      <div className="p-10">
        <div>
          <h1 className="text-4xl text-pink-700 pb-10 font-semibold ">
            Internship At  LNCT
          </h1>
        </div>
        <div className=" text-pink-600    relative  mx-auto border-2">

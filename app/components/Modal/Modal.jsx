...
const Modal = ({ showModal, toggleModal }) => {
  ...
  <button type="submit" className="text-white justify-center flex items-center bg-yellow-500 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-blue-800">

    ...
    <>
      <div className="w-full flex h-[650px]  ">
        <div className="w-[850px] h-full flex flex-col justify-center items-center p-4 ">
          <h1 className="text-4xl font-semibold flex items-center text-pink-600 ">
      ...
      <h1 className="text-3xl bg-pink-600 p-6  text-white "> DEPARTMENT</h1>
      <div className="w-full grid grid-cols-3 justify-around   bg-pink-600 p-4">
      ...
      <section>
        <div className=" flex flex-col justify-center  mx-auto items-center p-10">
          <h1 className="text-pink-600 font-light  text-center  text-4xl">

...
export default function Navbar() {
  ...
  return (
    <div className=" text-white z-50">
      <div className="flex items-center justify-between p-2 bg-pink-700">
      ...
      <div className="flex items-center justify-between px-4 bg-pink-700">
      ...
      <div className="flex justify-around bg-pink-700 p-4">
        <div id="tmenu-institute">
          ...
          <div
            className={`megamenu-panel absolute top-30 left-0 w-screen bg-pink-700 nav-submenu  ${
            ...
            <ul class=" flex justify-around list-none">
              <li class="py-4 ">
                <h5 class="text-lg font-semibold mb-2">
                  <a href="#" class="text-pink-500 text-lg p-2">
                    Institute
                  </a>
                </h5>
                <ul>
        ...
        <div id="tmenu-institute">
          ...
          <div
            className={`megamenu-panel absolute top-30 left-0 w-screen bg-pink-400 nav-submenu  ${
          ...
          >
            <ul class="flex justify-around ">
              <li>
                <ul>
                  <li>
                    <a className="text-pink-500 text-lg p-2 " href="">
                      Admissions
                    </a>
                  </li>
                  <li>

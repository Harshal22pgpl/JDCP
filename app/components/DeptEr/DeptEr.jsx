    ...
    <div>
      ...
      <div className="w-full   ">
        <div className="w-full flex px-20 py-10  gap-7">
          <div className="w-2/3 ">
            <div className="p-10">
              <h2 className=" text-4xl text-pink-700 my-5">
        ...
        <div className="w-full flex flex-col px-20 gap-4 py-6">
          <h1 className="text-4xl text-pink-500 font-bold p-2">
            Academic Programmes
          </h1>
      ...
      <div className=" w-10/12 mx-auto p-10">
        <h1 className="py-3 text-center text-3xl text-pink-500 font-bold">
          List of Faculties
        </h1>

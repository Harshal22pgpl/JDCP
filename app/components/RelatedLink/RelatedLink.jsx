  ...
  return (
    <>
      <div className="border-2 w-[370px]  text-black rounded-lg p-3  ">
        ...
        {links.map((link) => (
          <Link href={link.link} key={link} className="text-gray-600 cursor-pointer border-b-2  mx-auto  hover:text-pink-800 px-4 py-3 w-11/12 flex justify-between items-center ">

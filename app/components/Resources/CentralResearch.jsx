    ...
    <div>
      ...
      <div>
        <div className='mb-[50px] ml-44'>
          <h2 className='text-[30px] text-fuchsia-900 font-bold p-10 pb-0 ml-40'><span className='text-pink-600'>CENTRAL</span> RESEARCH FACILITY</h2>
          <div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='mr-20 text-justify'>
            <p className='text-[14px] d text-gray-700'>
              ...
              <span className='text-pink-500'>“Central Research Facility”</span>.</p>
      ...
      <div>
        <div className='mb-[50px] ml-52'>
          <h2 className='text-[30px] text-fuchsia-900 font-bold p-10 pb-3 ml-40'><span className='text-pink-600'>OUR</span>  R & D RESOURSES</h2>
          <div>
      ...
      <div className='h-96 mt-32 bg-cyan-500'>
        <div className='mb-[50px] ml-52'>
          <h2 className='text-[30px] text-fuchsia-900 font-bold p-10 pb-3 ml-40'><span className='text-pink-600'>WHAT</span>  PEOPLE SAY</h2>
      ...
      <div>
        <div className='mb-[50px] ml-52'>
          <h2 className='text-[30px] text-fuchsia-900 font-bold p-10 pb-3 ml-40'>
            <span className='text-pink-600'>EVENTS &</span>  ACTIVITIES</h2>
          <div className='border-b-4 border-fuchsia-900 w-28 ml-[300px] mt-5'>
          </div>
          <div className='grid grid-cols-2 mt-10 gap-4 -ml-32 mr-16'>
            <div className='flex border border-gray-400 p-3'>
              ...
              <div className='ml-5'><h2 className='capitalize  hover:text-pink-600 text-fuchsia-900 font-bold text-[14px] mb-3'>Vigyan Jyoti Programme of DST Govt. of India</h2>
            ...
            <div className='flex border border-gray-400 h-80 p-3'>
              ...
              <div className='ml-5 w-'>
                <h2 className='capitalize hover:text-pink-600 text-fuchsia-900 font-bold text-[14px] mb-3'>I-STEM Tech Management Conclave 2023</h2>
                <div className='flex'>
            ...
            <div className='flex border border-gray-400 h-48 p-3'>
              <div className='w-[90%]'>
                <img className='w-full m-2 ' src="welcome.jpeg" alt="" /></div>
               <div className='ml-5 w-'>
                <h2 className='capitalize  hover:text-pink-600 text-fuchsia-900 font-bold text-[14px] mb-3'>Training program for WDXRF</h2>
                <div className='flex'>
                  <img className='w-4 h-4' src="calendar.png" alt="" />
            ...
            <div className='flex border border-gray-400 h-48 p-3'>
              <div className='w-[90%]'>
                <img className='w-full m-2 ' src="welcome.jpeg" alt="" /></div>
              <div className='ml-5 w-'>
                <h2 className='capitalize  hover:text-pink-600 text-fuchsia-900 font-bold text-[14px] mb-3'>Training programs for HRMS</h2>
                <div className='flex'>
                  <img className='w-4 h-4' src="calendar.png" alt="" />
            ...
            <div className='flex border border-gray-400 h-48 p-3'>
              <div className='w-[90%]'>
                <img className='w-full m-2 ' src="welcome.jpeg" alt="" /></div>
              <div className='ml-5 w-'>
                <h2 className='capitalize  hover:text-pink-600 text-fuchsia-900 font-bold text-[14px] mb-3'>Training programs for LSCM</h2>
                <div className='flex'>
                  <img className='w-4 h-4' src="calendar.png" alt="" />

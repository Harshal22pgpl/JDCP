  ...
  return (
    <>
      ...
      <div className="flex p-20  mx-auto">
        <div className="w-[25%] mx-auto ">
          ...
          <ul className="bg-gray-200 p-4 rounded-lg">
            ...
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">AIC</li>
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">
              Message From Head
            </li>
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">
              Alumni Affairs
            </li>
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">Services</li>
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">News</li>
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">
              Success Stories
            </li>
            <li className="mb-5 hover:bg-pink-400 p-4 rounded-md">Reunions</li>
            <li className=" hover:bg-pink-400 p-4 rounded-md">Contact Us</li>
          </ul>
        </div>
      ...
      <section className=" w-11/12 mx-auto">
        <div className=" w-8/9 rounded-t-md  sm:p-4  md:p-4 lg:p-5 p-4  border-black grid md:grid-cols-1 lg:grid-cols-4   sm:grid-cols-1  justify-center items-center   dark:bg-dpurple   bg-pink-400">
          <div className="  ">
            <Counter
              initialValue={0}
              targetValue={2000}
        ...
        <div className=" rounded-b-md   sm:p-4  md:p-4 lg:p-5 p-4  border-black grid md:grid-cols-1 lg:grid-cols-4   sm:grid-cols-1  justify-center items-center   dark:bg-dpurple  mb-12 bg-pink-400">
          <div className=" ">
            <Counter
              initialValue={0}
              targetValue={2000}
